...
namespace DM.Validators
{
    internal class ServiceResponsesValidator
    {
        /// <summary>
        ...
        internal static IActionResult CreateProblemResult(ControllerBase controller, int statusCode, string details)
            => controller.Problem(detail: details, statusCode: statusCode, type: "about:blank");
    }
}
